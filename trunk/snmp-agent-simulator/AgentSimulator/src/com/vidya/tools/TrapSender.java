...
public class TrapSender
{
	...
	{
		String[] args1 =
		{ "-p", "TRAP", "-v", "3", "-u", "noAuthNoPrivacy", "172.25.200.224/162", "1.3.6.1.2.1.1.3.0={t}0", "1.3.6.1.6.3.1.1.4.1.0={o}1.3.6.1.6.3.1.1.5.1",
				SnmpConstants.snmpTrapAddress.toString() + "={a}" + deviceIp, SnmpConstants.snmpTrapOID + "={o}" + trapOid };
		// String[] args1 = {"-p", "TRAP", "-v", "3",
		// "-a","MD5","-A","authPassphrase","-u", "authNoPrivacy",
		// "172.25.200.154/162", "1.3.6.1.2.1.1.3.0={t}0",
		...
		// String[] args1 = {"-p", "TRAP", "-v", "3",
		// "-a","MD5","-A","authPassphrase","-x","DES","-X","privPassphrase","-u",
		// "authPrivacy", "172.25.200.154/162",
