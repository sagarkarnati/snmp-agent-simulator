...
/**
 * The <code>HeaderData</code> represents the message header information of
 * SNMPv3 message.
 * 
 * @author Vidya Sagar
 * @version 1.0
 * 
 *          Date Jan 5, 2014 12:23:32 PM
 */
public class HeaderData implements BERSerializable
{
	...
	public void decodeBER(BERInputStream message) throws IOException
	{
		...
		{
			logger.debug("SNMPv3 header decoded: msgId=" + msgID + ", msgMaxSize=" + msgMaxSize + ", msgFlags=" + msgFlags.toHexString() + ", secModel="
					+ securityModel);
		}
